package com.alexbernat.kmmtranslator.android
...
import com.alexbernat.kmmtranslator.android.core.presentation.Routes
import com.alexbernat.kmmtranslator.android.translate.presentation.AndroidTranslateViewModel
import com.alexbernat.kmmtranslator.android.translate.presentation.components.TranslateScreen
import com.alexbernat.kmmtranslator.android.voice_to_text.presentation.AndroidVoiceToTextViewModel
import com.alexbernat.kmmtranslator.android.voice_to_text.presentation.components.VoiceToTextScreen
    ...
    NavHost(navController = navController, startDestination = Routes.TRANSLATE) {
        composable(route = Routes.TRANSLATE) {
            ...
            val voiceResult by it.savedStateHandle.getStateFlow<String?>("voiceResult", null)
                .collectAsState()
            LaunchedEffect(key1 = voiceResult, block = {
