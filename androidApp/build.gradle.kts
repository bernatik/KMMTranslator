...
android {
    namespace = "com.alexbernat.kmmtranslator.android"
    compileSdk = 33
    defaultConfig {
        applicationId = "com.alexbernat.kmmtranslator.android"
        minSdk = 23
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"

        testInstrumentationRunner = "com.alexbernat.kmmtranslator.android.TestHiltRunner"
    }
    buildFeatures {
        compose = true
    }
